...
namespace Finance_Manager_Backend.Migrations
{
    ...
    [Migration("20250515023748_AddedDefaultInitializationForDecimalProperties")]
    partial class AddedDefaultInitializationForDecimalProperties
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Finance_Manager_Backend.BusinessLogic.Models.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Finance_Manager_Backend.BusinessLogic.Models.User", b =>
                {
                    ...
                    b.Property<string>("SecondaryCurrency1")
                        .HasMaxLength(3)
                        .HasColumnType("nvarchar(3)")
                        .HasColumnName("secondary_currency_1");

                    b.Property<string>("SecondaryCurrency2")
                        .HasMaxLength(3)
                        .HasColumnType("nvarchar(3)")
